...
@router.delete("/cleanup", summary="清理历史操作日志")
async def cleanup_audit_logs(days: int = Query(30, ge=1, le=3650, description="保留最近多少天的日志")):
    deleted_count, before_time = await audit_log_controller.cleanup_expired(days)
    return Success(
